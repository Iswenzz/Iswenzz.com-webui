				...
				<motion.div variants={animationRight()} initial="exit" animate={inView ? "enter" : "exit"}>
					<Grid className={scss.grid} container component="section"
						...
						<article className={scss.article}>
							...
							<Spacing height="20px" />
							<Text component="h2" className="poiret-h2">{webStacks.title}</Text>
							<Text component="h4" className="ubuntu-h4">{webStacks.points}</Text>
						</article>
						<article className={scss.article}>
							<Text component="h2" className="poiret-h2">{software.title}</Text>
							<Text component="h4" className="ubuntu-h4">{software.points}</Text>
							<Spacing height="20px" />
							<Text component="h2" className="poiret-h2">{softwareStacks.title}</Text>
							<Text component="h4" className="ubuntu-h4">{softwareStacks.points}</Text>
						</article>
						<article className={scss.article}>
							<Text component="h2" className="poiret-h2">{level.title}</Text>
							<Text component="h4" className="ubuntu-h4">{level.points}</Text>
							<Spacing height="20px" />
							<Text component="h2" className="poiret-h2">{editors.title}</Text>
							<Text component="h4" className="ubuntu-h4">{editors.points}</Text>
						</article>
					</Grid>
				</motion.div>
			</Container>
